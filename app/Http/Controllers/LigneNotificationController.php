...
class LigneNotificationController extends Controller
{
    ...
    {
        try {
            $ligneNotification = new LigneNotification();
            $ligneNotification->notification_id = $request->notification_id;
            $ligneNotification->date = $request->date;
            if ($ligneNotification->save()) {
                return $this->successResponse($ligneNotification, 'Récupération réussie');
            }
        } catch (Exception $e) {
    ...
    {
        try {
            $ligneNotification = LigneNotification::findOrFail($id);
            $ligneNotification->notification_id = $request->notification_id;
            $ligneNotification->date = $request->date;
            if ($ligneNotification->save()) {
                return $this->successResponse($ligneNotification, 'Mise à jour réussie');
            }
        } catch (Exception $e) {
    ...
    public function destroy($id)
    {
        try {
            $ligneNotification = LigneNotification::findOrFail($id);
            if ($ligneNotification->delete()) {
                return $this->successResponse($ligneNotification, 'Suppression réussie');
            }
        } catch (Exception $e) {
    ...
    public function show($id)
    {
        try {
            $ligneNotification = LigneNotification::findOrFail($id);
             return $this->successResponse($ligneNotification, 'Ressource trouvée');
        } catch (Exception $e) {
